...
//出力する文字コードを設定
	...
	out.println("</p>");
	out.println("<p>性別:");
	out.println("<input type='radio' name='SEX' value ='1' checked>男");	
	out.println("<input type='radio' name='SEX' value ='2' >女");	
	out.println("</p>");
	out.println("<p>満足度:");
	...
	out.println("</select>");
	out.println("</p>");
	out.println("<p>お気に入りの商品:<br>");
	out.println("<textarea name='MESSAGE' rows='4' color='50' maxlength='25'></textarea>");
	out.println("</p>");
